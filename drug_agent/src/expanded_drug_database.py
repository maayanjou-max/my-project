...
class ExpandedDrugDatabase:
    ...
    def __init__(self):
        self.drugs_database = {
            ...
            'אספירין': {
                'names': ['אספירין', 'אצטילסליצילית', 'אקמול', 'aspirin', 'acetylsalicylic acid', 'acamol aspirin'],
                'generic_name': 'אצטילסליצילית',
                'english_name': 'aspirin',
                'category': 'משככי כאבים ונוגדי דלקת לא סטרואידליים',
                'description': 'משכך כאבים, מוריד חום ונוגד דלקת. משמש גם למניעת קרישי דם',
                'indications': ['כאבי ראש', 'חום', 'כאבי שרירים', 'מניעת התקף לב', 'מניעת שבץ'],
                'dosage': {
                    'adults': 'משכך כאבים: 500-1000 מ"ג כל 4-6 שעות (מקסימום 4 גרם ליום). מניעה: 75-100 מ"ג פעם ביום',
                    'children': 'ילדים מעל 16 שנים: 300-600 מ"ג כל 4-6 שעות'
                },
                'timing': {
                ...
                'pregnancy': {
                    ...
                    'details': '⚠️ מסוכן בהריון! בטוח בשלישיות ראשונה ושנייה במינונים נמוכים, אסור לחלוטין בשלישיית שלישי - עלול לגרום לסגירת צינור עורקי ודימום'
                },
                'breastfeeding': {
                    'safe': False,
                    'details': 'להימנע בהנקה - עובר לחלב האם ועלול לגרום לתסמונת ריי בתינוק'
                },
                'side_effects': {
                    'common': ['גירוי קיבה', 'צרבת', 'בחילה', 'כאבי בטן'],
                    'serious': ['כיב קיבה', 'דימום קיבה', 'אסתמה', 'תסמונת ריי בילדים'],
                    'overdose_warning': '⚠️ מינון יתר מסוכן - עלול לגרום לרעילות חמורה'
                },
                'interactions': {
                    'alcohol': '⚠️ סכנה! אלכוהול מגביר את הסיכון לדימום קיבה',
                    'medications': ['וורפרין (סיכון דימום)', 'מטוטרקסט', 'ליתיום', 'לחץ דם']
                },
                'contraindications': ['אלרגיה לאספירין', 'כיב קיבה פעיל', 'אסתמה חמורה', 'הריון (שלישיית שלישי)', 'ילדים מתחת לגיל 16'],
                'sources': ['MedlinePlus', 'UpToDate', 'FDA', 'מאגר תרופות מקומי']
            },
            ...
            'ציפרלקס': {
                'names': ['ציפרלקס', 'אסציטלופרם', 'cipralex', 'escitalopram', 'lexapro'],
                'generic_name': 'אסציטלופרם',
                'english_name': 'escitalopram',
                'category': 'נוגד דיכאון SSRI',
                'description': 'נוגד דיכאון לטיפול בדיכאון וחרדה',
                'indications': ['דיכאון', 'הפרעת חרדה מוכללת', 'הפרעת פאניקה', 'הפרעה אובססיבית-קומפולסיבית'],
                'dosage': {
                    'adults': 'מבוגרים: התחלה 10 מ"ג ביום, ניתן להגדיל ל-20 מ"ג ביום',
                    'elderly': 'קשישים: 5-10 מ"ג ביום'
                },
                'timing': {
                    'with_food': 'עם או בלי אוכל',
                ...
                'pregnancy': {
                    'safe': False,
                    'category': 'C',
                    'details': '⚠️ זהירות בהריון - יש לשקול יחס סיכון-תועלת. עלול לגרום לתסמינים בילוד'
                },
                'breastfeeding': {
                    'safe': False,
                    'details': 'זהירות בהנקה - עובר לחלב האם, יש להתייעץ עם רופא'
                },
                'side_effects': {
                    'common': ['בחילה', 'כאב ראש', 'נדודי שינה', 'עייפות', 'פגיעה בתפקוד מיני'],
                    'serious': ['מחשבות אובדניות (בתחילת הטיפול)', 'תסמונת סרוטונין', 'היפונטרמיה'],
                    'overdose_warning': '⚠️ אין להפסיק פתאום - הפסקה הדרגתית נדרשת'
                },
                'interactions': {
                    'alcohol': 'להימנע מאלכוהול - עלול להגביר דיכאון ותופעות לוואי',
                    'medications': ['MAO inhibitors - אסור לחלוטין', 'טרמדול', 'וורפרין', 'נוגדי דלקת NSAIDs']
                },
                'contraindications': ['אלרגיה למרכיב', 'נטילת MAO inhibitors', 'ילדים מתחת לגיל 18'],
                'sources': ['MedlinePlus', 'UpToDate', 'FDA', 'מאגר תרופות מקומי']
            },

            'זולפט': {
                'names': ['זולפט', 'סרטרלין', 'zoloft', 'sertraline', 'lustral'],
                'generic_name': 'סרטרלין',
                'english_name': 'sertraline',
                'category': 'נוגד דיכאון SSRI',
                'description': 'נוגד דיכאון לטיפול בדיכאון, חרדה והפרעות קשורות',
                'indications': ['דיכאון חמור', 'הפרעת פאניקה', 'הפרעה אובססיבית-קומפולסיבית', 'הפרעת חרדה חברתית', 'PTSD'],
                'dosage': {
                    'adults': 'מבוגרים: התחלה 25-50 מ"ג ביום, הגדלה הדרגתית עד 200 מ"ג ביום',
                    'children': 'ילדים 6-17 שנים: 25 מ"ג ביום (OCD בלבד)'
                },
                'timing': {
                    'with_food': 'עם או בלי אוכל',
                    'best_time': 'בבוקר או בערב, באותה שעה מדי יום'
                ...
                'side_effects': {
                    'common': ['בחילה', 'שלשול', 'נדודי שינה', 'עייפות', 'יובש בפה', 'פגיעה בתפקוד מיני'],
                    'serious': ['מחשבות אובדניות', 'תסמונת סרוטונין', 'דימום חריג', 'היפונטרמיה'],
                    'overdose_warning': '⚠️ הפסקה הדרגתית בלבד - הפסקה פתאומית יכולה לגרום לתסמונת נסיגה'
                },
                'interactions': {
                    'alcohol': 'להימנע מאלכוהול - מגביר דיכאון ועייפות',
                    'medications': ['MAO inhibitors - אסור!', 'וורפרין - מגביר דימום', 'טרמדול', 'נוגדי דלקת NSAIDs']
                },
                'contraindications': ['אלרגיה לסרטרלין', 'נטילת MAO inhibitors בתוך 14 יום'],
                'sources': ['MedlinePlus', 'UpToDate', 'FDA', 'מאגר תרופות מקומי']
            },

            'אדביל': {
                'names': ['אדביל', 'איבופרופן', 'נורופן', 'ברופן', 'advil', 'ibuprofen', 'nurofen', 'brufen'],
                'generic_name': 'איבופרופן',
                'english_name': 'ibuprofen',
                'category': 'נוגד דלקת לא סטרואידלי (NSAID)',
                'description': 'משכך כאבים, מוריד חום ונוגד דלקת',
                'indications': ['כאבי ראש', 'כאבי שרירים', 'חום', 'כאב מחזור', 'דלקת פרקים', 'כאבי שיניים'],
                'dosage': {
                    'adults': 'מבוגרים: 200-400 מ"ג כל 4-6 שעות (מקסימום 1200 מ"ג ליום ללא מרשם רופא)',
                    'children': 'ילדים מעל 6 חודשים: 5-10 מ"ג לק"ג כל 6-8 שעות'
                },
                'timing': {
                    'with_food': 'עם אוכל כדי למנוע גירוי קיבה',
                    'best_time': 'אחרי ארוחה עם כוס מים'
                },
                'pregnancy': {
                    'safe': False,
                    'category': 'C (D בשלישיית שלישי)',
                    'details': '⚠️ להימנע בהריון! בטוח יחסית בשלישיות ראשונה ושנייה, אסור בשלישיית שלישי - עלול לגרום לבעיות לב אצל העובר'
                },
                'breastfeeding': {
                    'safe': True,
                    'details': 'בטוח בהנקה - כמות מינימלית עוברת לחלב האם'
                },
                'side_effects': {
                    'common': ['גירוי קיבה', 'צרבת', 'בחילה', 'סחרחורת'],
                    'serious': ['כיב קיבה', 'דימום קיבה', 'בעיות כליות', 'בעיות לב וכלי דם'],
                    'overdose_warning': '⚠️ אין לחרוג מהמינון המומלץ - עלול לפגוע בקיבה ובכליות'
                },
                'interactions': {
                    'alcohol': '⚠️ מגביר סיכון לדימום קיבה',
                    'medications': ['וורפרין - מגביר דימום', 'תרופות לחץ דם', 'ליתיום', 'מטוטרקסט']
                },
                'contraindications': ['אלרגיה לאיבופרופן', 'כיב קיבה פעיל', 'אי ספיקת לב חמורה', 'בעיות כליות חמורות'],
                'sources': ['MedlinePlus', 'UpToDate', 'FDA', 'מאגר תרופות מקומי']
            },
